  ...
  module V1
    ...
    class ExaminationTypesController < ApiController
      ...
      def create
        ...
        return success_response({ message: I18n.t('examination_types.create') }) if @examination_type.save
      ...
      def update
        if @examination_type.update(examination_type_params)
          return success_response({ message: I18n.t('examination_types.update') })
        end
      ...
      def destroy
        return success_response({ message: I18n.t('examination_types.destroy') }) if @examination_type.destroy
      ...
      def set_examination_type
        ...
        error_response({ error: I18n.t('examination_types.not_found') }) unless @examination_type
      end
